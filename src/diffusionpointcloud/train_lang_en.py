...
parser.add_argument('--lang_dataset_path', type=str, default='./data/aligned_text_data.hdf5')
parser.add_argument('--emb_dataset_path', type=str, default='./data/aligned_text_data.hdf5')
...
if args.resume is not None:
    ...
    if (args.model == "T5"):
        model = T5Enconder(ckpt['args']).to(args.device)
    model.load_state_dict(ckpt['state_dict'])
else:
    if (args.model == "T5"):
        model = T5Enconder(args).to(args.device)
...
train_dset = NLShapeNetCoreEmbeddings(
    ...
    embedding_pa=args.emb_dataset_path,
